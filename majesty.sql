...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 04 jan. 2026 à 13:52
...
(2, 'carte_test1', 'carte_test1'),
(3, 'carte_test2', 'carte_test2');
...
(1, 5, 13, '2026-01-04', '13:19:02', 84.80, 1);
...
--
ALTER TABLE `carte`
  MODIFY `idCarte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `commandeitem`
  MODIFY `idCommandeItem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
