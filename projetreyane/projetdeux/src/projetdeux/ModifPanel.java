...
public class ModifPanel extends JFrame{
	...
	private void ajouter() {
		...
		DefaultTableModel model = new DefaultTableModel();
		model = generalDAO.getTable("SELECT * FROM "+tableChoisi);
		Map<String, JTextField> champs = new LinkedHashMap<>();
		for(int i = 1;i<model.getColumnCount();i++) {
			System.out.println(model.getColumnName(i));
			System.out.println(model.getColumnCount());
			
			JTextField nv_textfield = new JTextField();
		...
		JButton submitCart2 = new JButton("Ajouter");
		...
		submitCart2.addActionListener(e -> {	
			...
			for(String item : tab_set) {
				...
				String requete = "INSERT INTO "+tableChoisi+"("+colonnes+") VALUES('"+valeurs+"')";
	...
	private void modifier() {
		...
		submitCart.addActionListener(e -> {	
			...
			for(String item : tab_set) {
				...
				String requete = "UPDATE "+tableChoisi+" SET "+update_requete+" WHERE "+update_condition;
				System.out.println(requete);
				generalDAO.RequeteTable(requete);
				System.out.println("Ajout BON");
				afficherBDD("SELECT * FROM "+tableChoisi,tableChoisi);
	...
	private void supprimer() {
		...
		submitCate.addActionListener(e -> {	
			...
			for(String item : tab_set) {
				...
				String requete = "DELETE FROM "+tableChoisi+" WHERE "+update_condition;
				System.out.println(requete);
				generalDAO.RequeteTable(requete);
				System.out.println("Ajout BON");
				afficherBDD("SELECT * FROM "+tableChoisi,tableChoisi);
